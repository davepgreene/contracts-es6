 ...
 * @return {Interface}
 */
const Interface = function Interface(klass, m) {
  ...
  const Self = class {
    ...
    constructor() {
      ...
      const errors = Self.implementationErrors(obj, contract, m);
  ...
  Self.implementationErrors = implementationErrors(Self, klass);
  Self.interface = klass;
